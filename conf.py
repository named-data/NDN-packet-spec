...
htmlhelp_basename = 'NDNspecificationdoc'
...
latex_documents = [
  ('index', 'ndn-spec.tex', u'NDN specification Documentation',
   u'NDN Project Team', 'howto'),
]
...
man_pages = [
    ('index', 'ndn-spec', u'NDN specification Documentation',
...
texinfo_documents = [
  ('index', 'ndn-spec', u'NDN specification Documentation',
   u'NDN Project Team', 'NDNspecification', 'One line description of project.',
   'Miscellaneous'),
]
